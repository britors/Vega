...
impl NetworkPage {
        ...
        for i in items {
            ...
            self.interfaces.append(
                &ActionRow::builder()
                    ...
                    .subtitle(gtk::glib::markup_escape_text(&sub).to_string())
                    .build()
                    .widget,
            );
        }
    ...
    pub fn show_wifi(&self, items: &[WifiNetwork]) {
        ...
        for i in items {
            ...
            let row = ActionRow::builder()
                .title(gtk::glib::markup_escape_text(&i.ssid).to_string())
                .subtitle(gtk::glib::markup_escape_text(&sub).to_string())
                .build();
    ...
    pub fn show_firewall(&self, status: &FirewallStatus, services: &[FirewallService]) {
        ...
        for service in services {
            let row = ActionRow::builder()
                .title(gtk::glib::markup_escape_text(&service.label).to_string())
                .subtitle(gtk::glib::markup_escape_text(&service.name).to_string())
                .activatable(true)
                .build();
            row.add_suffix(
                &gtk::Label::builder()
            ...
            self.firewall_services.append(&row.widget);
        }
...
fn empty(l: &gtk::ListBox, t: &str) {
    l.append(&ActionRow::builder().title(t).build().widget);
}
fn dash(v: &str) -> &str {
