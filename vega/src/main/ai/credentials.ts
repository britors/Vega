...
export async function saveApiKey(provider: AIProviderId, apiKey: string): Promise<void> {
  if (!safeStorage.isEncryptionAvailable()) {
    throw new Error('Armazenamento seguro indisponível. Nenhum serviço de keyring, como gnome-keyring ou KWallet, foi detectado. Não é possível salvar a chave com segurança.')
  }
